...
| 成员 | 学号 | 分工 |
|------|------|------|
| 韦奕澳 | 231603030614 | 后端开发、系统架构、测试 |
| 阮本顺 | 231603030609 | 前端开发、UI 组件、测试 |
| 秦际豪 | 231603030611 | 算法实现、Agent 节点、测试 |
| 刘源 | 231603030613 | 文档生成模块、模板设计、测试 |
| 李功源 | 231603030605 | 知识库构建、数据采集 |
